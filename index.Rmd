...
```{r echo=FALSE}
text =paste("German Population pyramid for Scenario :", "Variante 1-W1 EJ", "\n (in 100 thousand)")
load("pyramid.RData"); py.Males <- as.numeric(sheet[1,5:105]) ; names(py.Males) <- names[5:105]; py.Females <- as.numeric(sheet[2,5:105])   
```
